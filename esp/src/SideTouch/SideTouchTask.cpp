...
SideTouchTask::SideTouchTask(int task_core, const SenderConfig &sender_config, int prescaler,
                             const std::function<void(uint8_t)> &update_touch_count_for_motor_callback)
	: Task("SideTouch", 10000, 1, task_core), sender_config_(sender_config),
	  update_touch_count_for_motor_callback_(update_touch_count_for_motor_callback)
{
